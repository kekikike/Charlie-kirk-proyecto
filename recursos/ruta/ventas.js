...
const { crearVenta, obtenerVentas, obtenerDetallesVenta, obtenerMetodosPago, generarTicket, obtenerEstadisticasDashboard } = require('../controladores/ventas.js');
...
// Rutas protegidas
router.get('/estadisticas', verificarToken, obtenerEstadisticasDashboard);
