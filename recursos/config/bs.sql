...
CREATE TABLE templeados (
    ...
    ciempleado_enc LONGTEXT COMMENT 'CI Empleado encriptado (opcional)',
    fecharegistro DATETIME DEFAULT CURRENT_TIMESTAMP,
    estado BIT DEFAULT 1,
    rol int,
    usuarioA INT,
...
CREATE TABLE tventas (
    ...
    ci_nit_enc LONGTEXT COMMENT 'CI/NIT del cliente encriptado con AES-256-CBC',
    ciempleado INT,
    ciempleado_enc LONGTEXT COMMENT 'CI del vendedor encriptado (referencia)',
    idmetodo INT,
    fechaventa DATE,
    hora TIME,
